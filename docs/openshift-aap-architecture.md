...
- In-cluster EDB clusters follow **EDB Postgres for Kubernetes** CRDs (`postgresql.k8s.enterprisedb.io/v1`). See **[`docs/install-kubernetes-manual.md`](install-kubernetes-manual.md)** and **[`db-deploy/README.md`](../db-deploy/README.md)**.
